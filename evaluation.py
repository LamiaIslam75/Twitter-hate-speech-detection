...
def f_1(classifier, data):
    ...
    for item, true_label in data:
        ...
        if predicted_label == 'offensive' and true_label == 'offensive':
            true_positives += 1
        elif predicted_label == 'offensive' and true_label == 'nonoffensive':
            false_positives += 1
        elif predicted_label == 'nonoffensive' and true_label == 'offensive':
            false_negatives += 1
